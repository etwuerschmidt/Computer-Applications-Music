...
/*  This class is used to represent a user parameter. 
    
    It handles all user parameter value mapping and conversion.
    ...
    normalized values are always 0.0 to 1.0
    actual values are always between the actual minimum and actual maximum
 
    The parameter value is wrapped using JUCE's Atomic class to make the value thread
    safe.
 
    Created by Brian Uosseph, 2015
 */
...
public:
	...
	///
	/// No convention that name cannot change.
