...
public:
	...
	PluginParameter* lowShelfFCUParam;
	PluginParameter* lowShelfGainUParam;
	PluginParameter* midFCUParam;
	PluginParameter* midGainUParam;
	PluginParameter* highShelfFCUParam;
...
private:
	...
	float fs;	//Frequency sampling rate
	float lowShelfFCAParam;
	float lowShelfGainAParam;
	float midFCAParam;
	float midGainAParam;
	float highShelfFCAParam;
	float highShelfGainAParam;
	stk::BiQuad lowShelfFilterL, lowShelfFilterR;	//Filter objects
	stk::BiQuad midFilterL, midFilterR;
	stk::BiQuad highShelfFilterL, highShelfFilterR;
};
